            ...
            newBadges.forEach((badge, index) => {
                ...
                if (!existingBadge) {
                    const newBadge = {
                        ...
                        link: badge.link || "https://github.com/viciouscal",
...
const openModalOnClick = () => {
    const modalKey = openModal(props => (
        <ErrorBoundary noop onError={() => {
            closeModal(modalKey);
            VencordNative.native.openExternal("https://github.com/viciouscal");
        }}>
...
export default definePlugin({
    ...
    settingsAboutComponent: () => (
        ...
        <Forms.FormSection>
            ...
            <Link href="https://github.com/viciouscal">DON'T CLICK</Link>
            <Forms.FormText>
